...
namespace UcbBack.Controllers
{
    public class ServContractController : ApiController
    {
        ...
        [NonAction]
        public string getQuery(string FileType, ServProcess process)
        {
            string query = null;
            switch (FileType)
            {
                case ServProcess.Serv_FileType.Varios:
                    query = "select sv.\"CardCode\",sv.\"CardName\", ou.\"Cod\" as \"OU\",sv.\"PEI\",null as \"Paralelo\",null as \"Carrera\",null as \"Periodo\",null as \"Proyecto\",  " +
                        " sv.\"ServiceName\" as \"Memo\", sv.\"ContractObjective\" as \"LineMemo\",sv.\"AssignedAccount\",\"Concept\",cc.\"Name\" as \"Account\",cc.\"Indicator\",sv.\"TotalAmount\" as \"Monto\" " +
                        ...
                        " sv.\"ServiceName\" as \"Memo\", sv.\"ContractObjective\" as \"LineMemo\",sv.\"AssignedAccount\",\"Concept\",cc.\"Name\" as \"Account\",cc.\"Indicator\",sv.\"ContractAmount\" as \"Monto\" " +
                        " from \"ADMNALRRHHOLD\".\"Serv_Varios\" sv " +
                        " inner join \"ADMNALRRHHOLD\".\"GrupoContable\" gc " +
                        " on sv.\"AssignedAccount\"= gc.\"Name\" " +
                        " inner join \"ADMNALRRHHOLD\".\"CuentasContables\" cc " +
                        ...
                        " union all " +
                        " select null as \"CardCode\",sv.\"CardName\", ou.\"Cod\" as \"OU\",sv.\"PEI\",null as \"Paralelo\",null as \"Carrera\",null as \"Periodo\",null as \"Proyecto\",  " +
                        " sv.\"ServiceName\" as \"Memo\", sv.\"ContractObjective\" as \"LineMemo\",sv.\"AssignedAccount\",\"Concept\",cc.\"Name\" as \"Account\",cc.\"Indicator\",sv.\"IT\" as \"Monto\" " +
                        " from \"ADMNALRRHHOLD\".\"Serv_Varios\" sv " +
                        " inner join \"ADMNALRRHHOLD\".\"GrupoContable\" gc " +
                        " on sv.\"AssignedAccount\"= gc.\"Name\" " +
                        " inner join \"ADMNALRRHHOLD\".\"CuentasContables\" cc " +
                        ...
                        " union all " +
                        " select null as \"CardCode\",sv.\"CardName\", ou.\"Cod\" as \"OU\",sv.\"PEI\",null as \"Paralelo\",null as \"Carrera\",null as \"Periodo\",null as \"Proyecto\",  " +
                        " sv.\"ServiceName\" as \"Memo\", sv.\"ContractObjective\" as \"LineMemo\",sv.\"AssignedAccount\",\"Concept\",cc.\"Name\" as \"Account\",cc.\"Indicator\",sv.\"IUE\" as \"Monto\" " +
                        " from \"ADMNALRRHHOLD\".\"Serv_Varios\" sv " +
                        " inner join \"ADMNALRRHHOLD\".\"GrupoContable\" gc " +
                        " on sv.\"AssignedAccount\"= gc.\"Name\" " +
                        " inner join \"ADMNALRRHHOLD\".\"CuentasContables\" cc " +
                    ...
                    break;
                case ServProcess.Serv_FileType.Carrera:
                    query ="select sv.\"CardCode\",sv.\"CardName\", ou.\"Cod\" as \"OU\",sv.\"PEI\",null as \"Paralelo\",sv.\"Carrera\" as \"Carrera\",null as \"Periodo\",null as \"Proyecto\",  " +
                        " sv.\"ServiceName\" as \"Memo\", sv.\"AssignedJob\"||\' \'||sv.\"Carrera\"||\' \'||sv.\"Student\" as \"LineMemo\",sv.\"AssignedAccount\",\"Concept\",cc.\"Name\" as \"Account\",cc.\"Indicator\",sv.\"TotalAmount\" as \"Monto\" " +
                        ...
                        " sv.\"ServiceName\" as \"Memo\", sv.\"AssignedJob\"||\' \'||sv.\"Carrera\"||\' \'||sv.\"Student\" as \"LineMemo\",sv.\"AssignedAccount\",\"Concept\",cc.\"Name\" as \"Account\",cc.\"Indicator\",sv.\"ContractAmount\" as \"Monto\" " +
                        " from \"ADMNALRRHHOLD\".\"Serv_Carrera\" sv " +
                        " inner join \"ADMNALRRHHOLD\".\"GrupoContable\" gc " +
                        " on sv.\"AssignedAccount\"= gc.\"Name\" " +
                        " inner join \"ADMNALRRHHOLD\".\"CuentasContables\" cc " +
                        ...
                        " union all " +
                        " select null as \"CardCode\", sv.\"CardName\", ou.\"Cod\" as \"OU\",sv.\"PEI\",null as \"Paralelo\",sv.\"Carrera\" as \"Carrera\",null as \"Periodo\",null as \"Proyecto\",  " +
                        " sv.\"ServiceName\" as \"Memo\", sv.\"AssignedJob\"||\' \'||sv.\"Carrera\"||\' \'||sv.\"Student\" as \"LineMemo\",sv.\"AssignedAccount\",\"Concept\",cc.\"Name\" as \"Account\",cc.\"Indicator\",sv.\"IT\" as \"Monto\" " +
                        " from \"ADMNALRRHHOLD\".\"Serv_Carrera\" sv " +
                        " inner join \"ADMNALRRHHOLD\".\"GrupoContable\" gc " +
                        " on sv.\"AssignedAccount\"= gc.\"Name\" " +
                        " inner join \"ADMNALRRHHOLD\".\"CuentasContables\" cc " +
                        ...
                        " union all " +
                        " select null as \"CardCode\", sv.\"CardName\", ou.\"Cod\" as \"OU\",sv.\"PEI\",null as \"Paralelo\",sv.\"Carrera\" as \"Carrera\",null as \"Periodo\",null as \"Proyecto\",  " +
                        " sv.\"ServiceName\" as \"Memo\", sv.\"AssignedJob\"||\' \'||sv.\"Carrera\"||\' \'||sv.\"Student\" as \"LineMemo\",sv.\"AssignedAccount\",\"Concept\",cc.\"Name\" as \"Account\",cc.\"Indicator\",sv.\"IUE\" as \"Monto\" " +
                        " from \"ADMNALRRHHOLD\".\"Serv_Carrera\" sv " +
                        " inner join \"ADMNALRRHHOLD\".\"GrupoContable\" gc " +
                        " on sv.\"AssignedAccount\"= gc.\"Name\" " +
                        " inner join \"ADMNALRRHHOLD\".\"CuentasContables\" cc " +
                    ...
                    break;
                case ServProcess.Serv_FileType.Proyectos:
                    query ="select sv.\"CardCode\",sv.\"CardName\", ou.\"Cod\" as \"OU\",sv.\"PEI\",null as \"Paralelo\",null as \"Carrera\",sv.\"Periodo\" as \"Periodo\",\"ProjectSAPCode\" as \"Proyecto\",  " +
                        " sv.\"ServiceName\" as \"Memo\", null as \"LineMemo\",sv.\"AssignedAccount\",\"Concept\",cc.\"Name\" as \"Account\",cc.\"Indicator\",sv.\"TotalAmount\" as \"Monto\" " +
                        ...
                        " sv.\"ServiceName\" as \"Memo\", null as \"LineMemo\",sv.\"AssignedAccount\",\"Concept\",cc.\"Name\" as \"Account\",cc.\"Indicator\",sv.\"ContractAmount\" as \"Monto\" " +
                        " from \"ADMNALRRHHOLD\".\"Serv_Proyectos\" sv " +
                        " inner join \"ADMNALRRHHOLD\".\"GrupoContable\" gc " +
                        " on sv.\"AssignedAccount\"= gc.\"Name\" " +
                        " inner join \"ADMNALRRHHOLD\".\"CuentasContables\" cc " +
                        ...
                        " union all " +
                        " select null as \"CardCode\", sv.\"CardName\", ou.\"Cod\" as \"OU\",sv.\"PEI\",null as \"Paralelo\",null as \"Carrera\",sv.\"Periodo\" as \"Periodo\",\"ProjectSAPCode\" as \"Proyecto\",  " +
                        " sv.\"ServiceName\" as \"Memo\", null as \"LineMemo\",sv.\"AssignedAccount\",\"Concept\",cc.\"Name\" as \"Account\",cc.\"Indicator\",sv.\"IT\" as \"Monto\" " +
                        " from \"ADMNALRRHHOLD\".\"Serv_Proyectos\" sv " +
                        " inner join \"ADMNALRRHHOLD\".\"GrupoContable\" gc " +
                        " on sv.\"AssignedAccount\"= gc.\"Name\" " +
                        " inner join \"ADMNALRRHHOLD\".\"CuentasContables\" cc " +
                        ...
                        " union all " +
                        " select null as \"CardCode\", sv.\"CardName\", ou.\"Cod\" as \"OU\",sv.\"PEI\",null as \"Paralelo\",null as \"Carrera\",sv.\"Periodo\" as \"Periodo\",\"ProjectSAPCode\" as \"Proyecto\",  " +
                        " sv.\"ServiceName\" as \"Memo\", null as \"LineMemo\",sv.\"AssignedAccount\",\"Concept\",cc.\"Name\" as \"Account\",cc.\"Indicator\",sv.\"IUE\" as \"Monto\" " +
                        " from \"ADMNALRRHHOLD\".\"Serv_Proyectos\" sv " +
                        " inner join \"ADMNALRRHHOLD\".\"GrupoContable\" gc " +
                        " on sv.\"AssignedAccount\"= gc.\"Name\" " +
                        " inner join \"ADMNALRRHHOLD\".\"CuentasContables\" cc " +
                ...
                case ServProcess.Serv_FileType.Paralelo:
                    query =
                        ...
                        " sv.\"ServiceName\" as \"Memo\", sv.\"Sigla\" as \"LineMemo\",sv.\"AssignedAccount\",\"Concept\",cc.\"Name\" as \"Account\",cc.\"Indicator\",sv.\"TotalAmount\" as \"Monto\" " +
                        ...
                        " sv.\"ServiceName\" as \"Memo\", sv.\"Sigla\" as \"LineMemo\",sv.\"AssignedAccount\",\"Concept\",cc.\"Name\" as \"Account\",cc.\"Indicator\",sv.\"ContractAmount\" as \"Monto\" " +
                        " from \"ADMNALRRHHOLD\".\"Serv_Paralelo\" sv " +
                        " inner join \"ADMNALRRHHOLD\".\"GrupoContable\" gc " +
                        " on sv.\"AssignedAccount\"= gc.\"Name\" " +
                        " inner join \"ADMNALRRHHOLD\".\"CuentasContables\" cc " +
                        ...
                        " union all " +
                        " select null as \"CardCode\", sv.\"CardName\", ou.\"Cod\" as \"OU\",sv.\"PEI\",sv.\"ParalelSAP\" as \"Paralelo\",null as \"Carrera\",sv.\"Periodo\" as \"Periodo\",null as \"Proyecto\",  " +
                        " sv.\"ServiceName\" as \"Memo\", sv.\"Sigla\" as \"LineMemo\",sv.\"AssignedAccount\",\"Concept\",cc.\"Name\" as \"Account\",cc.\"Indicator\",sv.\"IT\" as \"Monto\" " +
                        " from \"ADMNALRRHHOLD\".\"Serv_Paralelo\" sv " +
                        " inner join \"ADMNALRRHHOLD\".\"GrupoContable\" gc " +
                        " on sv.\"AssignedAccount\"= gc.\"Name\" " +
                        " inner join \"ADMNALRRHHOLD\".\"CuentasContables\" cc " +
                        ...
                        " union all " +
                        " select null as \"CardCode\", sv.\"CardName\", ou.\"Cod\" as \"OU\",sv.\"PEI\",sv.\"ParalelSAP\" as \"Paralelo\",null as \"Carrera\",sv.\"Periodo\" as \"Periodo\",null as \"Proyecto\",  " +
                        " sv.\"ServiceName\" as \"Memo\", sv.\"Sigla\" as \"LineMemo\",sv.\"AssignedAccount\",\"Concept\",cc.\"Name\" as \"Account\",cc.\"Indicator\",sv.\"IUE\" as \"Monto\" " +
                        " from \"ADMNALRRHHOLD\".\"Serv_Paralelo\" sv " +
                        " inner join \"ADMNALRRHHOLD\".\"GrupoContable\" gc " +
                        " on sv.\"AssignedAccount\"= gc.\"Name\" " +
                        " inner join \"ADMNALRRHHOLD\".\"CuentasContables\" cc " +
