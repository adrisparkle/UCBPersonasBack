...
namespace UcbBack.Logic.ExcelFiles
{
    public class AcademicExcel : ValidateExcelFile
    {
        ...
        public override bool ValidateFile()
        {
            ...
            bool v5 = VerifyColumnValueIn(17, _context.Dependencies.Where(x => x.BranchesId == Int32.Parse(this.segmentoOrigen)).Select(m => m.Cod).Distinct().ToList(), comment: "Esta Dependencia no existe en la Base de Datos Nacional.");
